...
def capability_brief() -> str:
    ...
    lines.append('- Reminders: create, list, cancel — one-shot or recurring (daily/weekdays/weekly/monthly, "remind me every day at 9 to take medicine"); they arrive as Telegram messages.')
