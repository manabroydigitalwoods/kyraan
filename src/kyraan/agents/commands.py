...
COMMANDS = [
    ...
    {"phrase": "when PM2.5 is above 90 switch to turbo, below switch to auto",
     "what": "standing rules that act: the purifier changes mode on each crossing and you hear about it",
     "words": "pm2.5 pm25 purifier turbo auto rule automatic switch air"},
    {"phrase": "news",
     "what": "today's top headlines for West Bengal, India and the world — dated, sourced, one point each ('bengal news', 'india news', 'world news' for one)",
     "words": "news headlines headline top stories today morning evening bengal india world"},
    {"phrase": "about my phone",
     "what": "your phone's battery, location permission and last report, via the Home Assistant app",
     "words": "phone battery iphone charging app"},
    ...
    {"phrase": "duties status",
     "what": "each duty's schedule, when it last spoke, what it holds",
     "words": "duties duty schedule proactive jobs"},
